...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { art: @info.art, benutzer_id: @info.benutzer_id, betreff: @info.betreff, datei: @info.datei, datum: @info.datum, text: @info.text }
    end
  ...
  test "should update info" do
    patch :update, id: @info, info: { art: @info.art, benutzer_id: @info.benutzer_id, betreff: @info.betreff, datei: @info.datei, datum: @info.datum, text: @info.text }
    assert_redirected_to info_path(assigns(:info))
  end
